...
for demo [click here](http://wilmer16.github.io/reactjs-shopping-cart/)
...
- if you wonder why reducers, actions and selectors are all in one file inside folder called `ducks`, [read more here](https://github.com/wilmer16/ducks-modular-redux).
